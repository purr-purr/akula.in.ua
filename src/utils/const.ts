...
// DATA
export const DATA_FILE: string = 'https://raw.githubusercontent.com/purr-purr/akula.in.ua/DATA/data.json';
...
// BACKEND
export const BACKEND_LOCALHOST: string = 'http://localhost:5000';
